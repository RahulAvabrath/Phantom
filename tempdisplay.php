                  ...
                  if($s_count<$limit)
                  {
                    ...
                    echo '
                        ...
                        <center><div class="displaypage" >
                          <th><img src="data:image/jpeg;base64,'.base64_encode($row['name'] ).'" height="300" width="300" class="img-thumnail" style="margin-right:100px; margin-bottom:50px;" /> 
                  ...
                  <div class="container_bot" style="color: white; position: absolute; bottom: 75%; left: 45%;" >
                    ...
                    <h1 style="font-size: 23px;"><b>Any querry? mail us </b></h1>
                         <hr>
                                ...
                                <input type="email" name="email" placeholder=" Enter your email-id" style="border-radius: 5px;"><br>
                                <input type="text" name="querry" placeholder=" Type your querry here" style="border-radius: 5px;"><br>
