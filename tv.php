...
<body >
        ...
        <div class="mid_bar" style="width: 100%; height: 5%; top:15%;position: absolute; left: 0%; background-color: #555;">  
          <br>
        <p1 style="position: relative;left: 26%;" ><a  href="displaypage.php" style="color:#ECEEDD;">HOME</a></p1>
        <p1 style="position: relative;left: 29%; color: #fff;" > |</p1>
        <p1 style="position: relative;left: 32%;" ><a  href="mobile.php" style="color:#ECEEDD;">Mobiles</a></p1>
        <p1 style="position: relative;left: 35%; color: #fff;" > |</p1>
        <p2 style="position: relative;left: 38%;" ><a  href="laptop.php" style="color:#ECEEDD;">Laptops</a></p2>
        <p1 style="position: relative;left: 41%; color: #fff;" > |</p1>
        <p3 style="position: relative;left: 44%;" ><a  href="tv.php" style="color:#ECEEDD;">TV</a></p3>
        <p1 style="position: relative;left: 47%; color: #fff;" > |</p1>
        <p4 style="position: relative;left: 50%;" ><a  href="washingmachine.php" style="color:#ECEEDD;">Washing Machines</a></p4>
...
<br>
      <div class="price">
        ...
        <input type="number" id="transcript" name="min" style="width: 80px; height: 35px;" > -
        <input type="number" id="transcript" name="max" style="width: 80px; height: 35px;">
...
<div class="vl" style="position: absolute;left: 17%; top: 25%;"></div>
...
//$query = "SELECT T.*, COUNT(C.id) as count FROM tbl_images T, checkout C ORDER BY p_cost desc" ;  
                      $query = "SELECT * FROM tbl_images WHERE p_type='tv' ORDER BY p_cost desc" ;  
                      $result = mysqli_query($connect, $query); 
...
<br><br>
                        ...
                        <center><div class="displaypage" >
                          <th><a  href="detail_display.php?id='.$row['id'].'" style="color:#fff;position:relative; left:0%;"><img src="data:image/jpeg;base64,'.base64_encode($row['name'] ).'" height="300" width="400" class="img-thumnail" style="margin-right:100px; margin-bottom:50px;" /> </a>
                        ...
                        </center><div class="line" style="border: 2px solid black;background-color: black; width:70%;position:relative; left:5%;"> </div>
                     </div>   
                  ...
                  else
                  {
                    ...
                    echo '<table ><tr>
                        ...
                        <center><div class="displaypage" >
                          <th><a  href="detail_display.php?id='.$row['id'].'" style="color:#fff;position:relative; left:-6%;"><img src="data:image/jpeg;base64,'.base64_encode($row['name'] ).'" height="300" width="400" class="img-thumnail" style="margin-right:100px; margin-bottom:50px;" /> </a>
      ...
      echo '<div class="line" style="border: 2px solid black;background-color: black; width:70%;position:relative; left:5%;"> </div>';
                  $s_count++;
                }
                echo "</tr></table";
