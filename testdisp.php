...
.dark-mode {
  background-image:linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.8)),url(lbg.jpg); height: 100vh;
  color: white;
                  ...
                  if($s_count<$limit)
                  {
                    ...
                    echo '
                        ...
                        <center><div class="displaypage" >
                          ...
                          <br><br><br><br><br>
                          <div class="panel-footer" style="position:relative; left:30%;"> <p2 ><button class="btn next-btn"><a  href="checkout.php?id='.$row['id'].'" style="color:#fff;">ADD To CART</a></button></p2></div>     <br><br>
<br><br><br><br><div class="feture" style="position:relative; left:-120%;">
                        <p00 style="position:relative; left:58%; font-size:27px;"><strong><u><b> Product Details </b></u></strong></p00><br><br>
                        <p01 style="position:relative; left:60%;"><strong> '.$row['f1'].' </strong></p01><br>
                        <p02 style="position:relative; left:60%;"><strong>'.$row['f2'].' </strong></p02><br>
                        <p03 style="position:relative; left:60%;"><strong>'.$row['f3'].' </strong></p03><br>
                        <p04 style="position:relative; left:60%;"><strong>'.$row['f4'].' </strong></p04><br>
                        <p05 style="position:relative; left:60%;"><strong>'.$row['f5'].' </strong></p05></td>
                 </div>       
...
<div class="row">
  <div class="column">
    <img src="data:image/jpeg;base64,'.base64_encode($row['name'] ).'" height="300" width="300" style="cursor:pointer; position:absolute; top:30%; left:28%; border: 4px solid #000;" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="data:image/jpeg;base64,'.base64_encode($row['img2'] ).'" height="50" width="50" style="cursor:pointer; position:absolute;left:20%; top:30%;border: 2px solid #000;"  onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="data:image/jpeg;base64,'.base64_encode($row['img3'] ).'" height="50" width="50" style="cursor:pointer;position:absolute;left:20%;top:35%;border: 2px solid #000;"  onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
  </div>
  <div class="column">
    <img src="data:image/jpeg;base64,'.base64_encode($row['img4'] ).'" height="50" width="50"  style="cursor:pointer;position:absolute;left:20%;top:40%;border: 2px solid #000;"  onclick="openModal();currentSlide(4)" class="hover-shadow cursor">
  </div>
</div>
...
<?php
   ...
   echo '<div class="line" style="border: 2px solid black;background-color: #12D1EC; width:70%;position:relative; left:5%;"> </div>';
                  $s_count++;
                }
                echo "</tr></table";
