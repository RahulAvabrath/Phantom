...
<center>
      ...
      <a href="test22.php" class="acc">
        <input type="submit" name="account" value="Account" style="width:100px; height: 50px; position: absolute; top: 5%; right: 30%;">
            ...
            <span class="accname" style="color:#fff ; font-size: 35px; position: absolute; right: 22%; top: 5.5%; text-transform:uppercase;"><b><?php echo "$username";?><b></span>
