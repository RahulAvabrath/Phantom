...
function closeNav() {
  document.getElementById("mySidenav").style.width = "0";
   ...
   <!-- end of mic rec thing working--> <!DOCTYPE html>
<html>
<link rel="stylesheet" type="text/css" href="billingaddress.css">
...
<div class="checkout-panel">
  ...
  <br><br>
    ...
    <div class="input-fields">
      <div class="column-1">
        ...
        <input type="text" id="cardholder" placeholder="Enter first name " />
 
        <div class="new">
          <div><br>
                <label for="cardholder">Phone Number</label>
                <input type="text" id="cardholder" placeholder="Enter valid phone number " />
          </div>
 

          <div><br>
               <label for="cardholder">Billing Address</label>
               <input type="text" id="cardholder" placeholder="Enter the adddress  " />
          </div>
      ...
      <div class="column-2">
          ...
          <div>
                ...
                <input type="text" id="cardholder" placeholder="Enter last name " />
          </div>

          <div><br>
                <label for="cardholder">PIN Code</label>
                <input type="text" id="cardholder" placeholder="Enter PIN Code " />
          </div>


          <div><br>
                  <label for="cardholder">State / Province / Region</label>
                  <input type="text" id="cardholder" placeholder="Enter State / Province / Region " />
          </div>

          <div>
      </div>
     <!-- <div class="column-3"  style="position: relative;right: 14%; ">
      <div>            
            <label> Address Type </label>
              <select style="width: 100%; height: 1000%;">
              <option value="cod">Home(7am - 9pm delivery)</option>
              <option value="cc">Office/Commercial(10am - 6pm delivery)</option>
              </select>                      
  ...
  <div class="panel-footer">
    ...
    <button class="btn next-btn" onclick="location.href = 'card.php';">Next Step</button>
  </div>
</div>
